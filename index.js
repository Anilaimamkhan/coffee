...
let btn6 = document.querySelector("section.blogs .container a.btn6");
let fixed = document.querySelector(".fixed");
let header = document.querySelector(".header")
let container = document.querySelector("section.blogs .container")
let blogs_content =document.querySelector(".blogs-content");
popup = document.querySelector("section.blogs .blogs-content a.btn-1");
...
const f =()=>{
    section.blogs .container.classList.remove("active");
    section.blogs .blogs-content.classList.toggle("active");
}
...
const fun = () => {
header.scrollIntoView({"scrollbehaviour":"smooth"},2000);
}
fixed.addEventListener("click", fun);
////////////////////
bars.onclick = () =>{
